...
public class OpenStreetMapsProxy implements GeoEncodingService {
    ...
    @Override
    public GeoCoordinate encodeAddress(String a) throws IOException, InterruptedException {
        String baseUrl = "https://nominatim.openstreetmap.org/search?";
        StringBuilder uriBuilder = new StringBuilder();
        uriBuilder.append(baseUrl);
        uriBuilder.append("q=").append(URLEncoder.encode(a, StandardCharsets.UTF_8));
